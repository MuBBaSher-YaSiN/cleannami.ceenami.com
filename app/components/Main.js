...
//           <div className="md:w-[30%] h-full sticky top-32 p-6 bg-gradient-to-br from-white to-blue-300 border border-gray-200 rounded-lg ">
...
const Main = () => {
  ...
  return (
    <>
      <form onSubmit={handleSubmit(onSubmit)} className="w-[95%] lg:w-[80%] mx-auto pb-20">
        <div className='flex max-md:flex-col gap-10 relative mt-20'>
          <div className='md:w-[70%]'>
            <WhoYouAreForm register={register} />
          ...
          <div className="md:w-[30%] h-full sticky top-36 p-6 bg-gradient-to-br from-white to-blue-300 border border-gray-200 rounded-lg ">
            <h2 className="text-xl font-bold mb-4">Order Summary</h2>
