    ...
    >
      ...
      <motion.div variants={itemVariants} className="relative mb-6">
        ...
        <motion.p
          ...
          animate={{ opacity: 1 }}
        >
          If you can't reserve the day and time that you want, feel free to call
          us at{" "}
          <motion.span
          ...
          and we will be happy to see if we can make scheduling arrangements for
          you.
        </motion.p>
      ...
      >
        ...
        >
          <motion.div
            ...
            animate={
              focusedField === "date" ? { rotate: [0, 15, 0, -15, 0] } : {}
            }
        ...
        >
          <motion.div
            className="absolute left-3 top-3 text-[#1115ac]"
            animate={
              focusedField === "time" ? { rotate: [0, 15, 0, -15, 0] } : {}
            }
            transition={{ duration: 0.5 }}
          >
            <svg
